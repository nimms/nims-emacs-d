(defun color-theme-tangotango ()
  ...
  (color-theme-install
   '(color-theme-tangotango
     ...
     (mode-line ((t (:foreground "white" :background "purple4" :box (:line-width 1 :color nil :style released-button)))))
     ...
     (erc-input-face ((t (:foreground "#98fb98"))))
     (erc-my-nick-face ((t (:foreground "#8470ff"))))
     (mumamo-background-chunk-submode1 ((t (:background "Gray28"))))
     (mumamo-background-chunk-submode2 ((t (:background "Gray29"))))
     (mumamo-background-chunk-submode3 ((t (:background "Gray30"))))
     (mumamo-background-chunk-submode4 ((t (:background "Gray31"))))
     (mumamo-background-chunk-major ((t (:background "Gray8"))))
