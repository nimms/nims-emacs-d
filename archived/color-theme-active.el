...
(defun color-theme-active ()
  ...
  (color-theme-install
   '(color-theme-active
     ...
     (default ((t (:stipple nil :background "SystemWindow" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :foundry "outline" :family "Terminus"))))
     ...
     (completions-common-part ((t (:family "Terminus" :foundry "outline" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :background "SystemWindow" :stipple nil :height 120))))
     ...
     (dired-perm-write ((t (:family "Terminus" :foundry "outline" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :background "SystemWindow" :stipple nil :height 120))))
